...
def patched_action():
    ...
    with patch('ao3downloader.actions.ao3download.FileOps', return_value=fileops), \
         patch('ao3downloader.actions.ao3download.Repository', return_value=repo), \
         patch('ao3downloader.actions.ao3download.Ao3', return_value=ao3) as ao3_class, \
